#
# Project automation script for dwarf
#
# Created for ISE version 14.6
#
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source dwarf.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "disp_mux.vhd"
   xfile add "sevseg.vhd"
   xfile add "spartan3board.ucf"
   xfile add "spartan3board.vhd"

   # Set the Top Module as well...
   project set top "logic" "spartan3board"
...
proc set_process_props {} {
   ...
   project set "Output File Name" "spartan3board" -process "Generate IBIS Model"
